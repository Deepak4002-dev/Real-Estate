  ...
  return (
    <div className="max-h-screen w-screen px-3 sm:px-14 md:px-24 lg:px-36 py-8 mb-16 ">
      ...
      >
        ...
        <Button
          type="submit"
          className="px-3 py-3 mt-3 w-full border-none outline-none bg-blue-600 text-white hover:bg-blue-500 rounded hover:scale-105 transition duration-200 ease-linear"
        >
          Log In
        </Button>
